import Screen_1 from "./screen_1/config";
import Screen_2 from "./screen_2/config";
import Screen_3 from "./screen_3/config";
import Screen_4 from "./screen_4/config";
import Screen_5 from "./screen_5/config";
import Screen_6 from "./screen_6/config";
...
export default {
  ...
  title: "Phonics",
  default: true,
  items : ["screen_1","screen_2", "screen_3","screen_4", "screen_5","screen_6"],
  byId : {
    screen_1: Screen_1,
    screen_2: Screen_2,
    screen_3: Screen_3,
